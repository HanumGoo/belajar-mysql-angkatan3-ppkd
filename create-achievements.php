...
if (isset($_POST['save'])) {
    ...
    if ($id) {
        ...
        header("location:app.php?page=achievements&tambah=berhasil");
            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="project_total" placeholder="Enter Project Total"
                            required value="<?php echo ($id) ? $row['project_total'] : '' ?>">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label fw-bold">Award Total</label>
                        <input type="number" class="form-control" name="award_total" placeholder="Enter Award Total"
                            required value="<?php echo ($id) ? $row['award_total'] : '' ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="coffee_total" placeholder="Enter Coffee Total"
                            required value="<?php echo ($id) ? $row['coffee_total'] : '' ?>">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="button_text" placeholder="Enter Button Text"
                            required value="<?php echo ($id) ? $row['button_text'] : '' ?>">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="button_link" placeholder="Enter Button Link"
                            required value="<?php echo ($id) ? $row['button_link'] : '' ?>">
                    </div>
                    <div class="mb-3">
